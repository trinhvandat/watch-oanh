...
import org.ptit.domain.Order;
import org.ptit.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().orderDate(DEFAULT_ORDER_DATE).receiverAddress(DEFAULT_RECEIVER_ADDRESS);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().orderDate(UPDATED_ORDER_DATE).receiverAddress(UPDATED_RECEIVER_ADDRESS);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getReceiverAddress()).isEqualTo(DEFAULT_RECEIVER_ADDRESS);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.orderDate(UPDATED_ORDER_DATE).receiverAddress(UPDATED_RECEIVER_ADDRESS);
        ...
        assertThat(testOrder.getReceiverAddress()).isEqualTo(UPDATED_RECEIVER_ADDRESS);
    }
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderDate(UPDATED_ORDER_DATE).receiverAddress(UPDATED_RECEIVER_ADDRESS);
