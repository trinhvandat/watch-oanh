...
class ReviewResourceIT {
    ...
    public static Review createEntity(EntityManager em) {
        Review review = new Review().comment(DEFAULT_COMMENT).rate(DEFAULT_RATE).reviewDate(DEFAULT_REVIEW_DATE);
        return review;
    }
    ...
    public static Review createUpdatedEntity(EntityManager em) {
        Review review = new Review().comment(UPDATED_COMMENT).rate(UPDATED_RATE).reviewDate(UPDATED_REVIEW_DATE);
        return review;
    }
    ...
    void putExistingReview() throws Exception {
        ...
        updatedReview.comment(UPDATED_COMMENT).rate(UPDATED_RATE).reviewDate(UPDATED_REVIEW_DATE);
    ...
    void fullUpdateReviewWithPatch() throws Exception {
        ...
        partialUpdatedReview.comment(UPDATED_COMMENT).rate(UPDATED_RATE).reviewDate(UPDATED_REVIEW_DATE);
