          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Payment Transaction <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {customer.paymentTransaction ? (
                      <Link to={`/payment-transaction/${customer.paymentTransaction.id}`}>{customer.paymentTransaction.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (location.href = `/customer/${customer.id}/delete`)}
                        color="danger"
                        size="sm"
