    ...
    <div>
      ...
      <div className="table-responsive">
        {sellerList && sellerList.length > 0 ? (
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/seller/${seller.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                        <FontAwesomeIcon icon="pencil-alt" />{' '}
                        <span className="d-none d-md-inline">Translation missing for entity.action.edit</span>
                      </Button>
                      <Button
                        onClick={() => (location.href = `/seller/${seller.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && <div className="alert alert-warning">No Sellers found</div>
        )}
      </div>
    </div>
  );
